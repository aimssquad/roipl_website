    ...
    <div class="container-fluid">
      ...
      <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
        ...
        <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item isotope-item filter-house">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item isotope-item filter-premium">
            <div class="portfolio-content h-100">
          ...
          <div class="col-lg-3 col-md-6 portfolio-item isotope-item filter-luxury">
            <div class="portfolio-content h-100">
