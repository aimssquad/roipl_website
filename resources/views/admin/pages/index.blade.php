...
<div class="row">
    <div class="col-lg-3 d-flex justify-content-start mb-3">
        <a href="{{ route('admin.pages.create') }}" class="btn btn-success me-2">
    ...
    <div class="col-lg-3 d-flex justify-content-start mb-3">
        <form action="{{ route('admin.exportTableData') }}" method="POST" id="exportForm">
            ...
            <input type="hidden" id="filenameInput" value="pages">
                            ...
                            @foreach($datas as $index => $data)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('admin.pages.edit', $data->id) }}" class="btn btn-primary btn-sm">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>

                                        <!-- Delete Form -->
                                        <form action="{{ route('admin.pages.destroy', $data->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
