...
<div class="pagetitle">
    <h1>Manage Visionnaire</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item">Events</li>
            <li class="breadcrumb-item active">Manage Visionnaire</li>
        </ol>
    </nav>
</div>
<div class="row">
                        ...
                        <tbody>
                            @foreach($datas as $index => $data)
                                <tr>
                                    ...
                                    <td>
                                        <!-- Edit Button -->
                                        <a href="{{ route('admin.visionnaires.index', $data->id) }}" class="btn btn-info btn-sm text-white">
