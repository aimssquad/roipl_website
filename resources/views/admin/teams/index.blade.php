...
<div class="row">
    <div class="col-lg-3 d-flex justify-content-start mb-3">
        <a href="{{ route('admin.teams.create') }}" class="btn btn-success me-2">
    ...
    <div class="col-lg-3 d-flex justify-content-start mb-3">
        <form action="{{ route('admin.exportTableData') }}" method="POST" id="exportForm">
            ...
            <input type="hidden" id="filenameInput" value="teams">
                        ...
                        <tbody>
                            @foreach($datas as $index => $data)
                                <tr>
                                    ...
                                    <td>
                                        <!-- Edit Button -->
                                        <a href="{{ route('admin.teams.edit', $data->id) }}" class="btn btn-primary btn-sm">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>

                                        <!-- Delete Form -->
                                        <form action="{{ route('admin.teams.destroy', $data->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
