...
<div class="pagetitle">
    ...
    <nav>
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Manage Our Story</li>
        </ol>
    </nav>
</div>
<div class="row">
    <div class="col-lg-3 d-flex justify-content-start mb-3">
        <a href="{{ route('admin.abouts.create') }}" class="btn btn-success me-2">
            <i class="bi bi-plus-circle"></i> Create New Our Story
        </a>
    </div>
    {{-- <div class="col-lg-3 d-flex justify-content-start mb-3">
