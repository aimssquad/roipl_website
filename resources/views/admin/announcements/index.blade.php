...
<div class="row">
    <div class="col-lg-3 d-flex justify-content-start mb-3">
        <a href="{{ route('admin.announcements.create') }}" class="btn btn-success me-2">
    ...
    <div class="col-lg-3 d-flex justify-content-start mb-3">
        <form action="{{ route('admin.exportTableData') }}" method="POST" id="exportForm">
            ...
            <input type="hidden" id="filenameInput" value="Announcement">
                        ...
                        <tbody>
                            @foreach($datas as $index => $data)
                                <tr>
                                    ...
                                    <td>
                                        <!-- Edit Button -->
                                        <a href="{{ route('admin.announcements.edit', $data->id) }}" class="btn btn-primary btn-sm">
                                            <i class="bi bi-pencil-square"></i> Edit
                                        </a>

                                        <!-- Delete Form -->
                                        <form action="{{ route('admin.announcements.destroy', $data->id) }}" method="POST" style="display:inline-block;">
                                            @csrf
                                            @method('DELETE')
