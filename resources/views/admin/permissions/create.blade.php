...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Create a New Permission</h5>
                    ...
                    <form action="{{ route('admin.permissions.store') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control @error('guard_name') is-invalid @enderror" id="inputGuardName" name="guard_name" placeholder="Enter guard name" value="{{ old('guard_name', 'web') }}" required readonly>
                                @error('guard_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
