...
<div class="pagetitle">
    <h1>Create Visionnaire</h1>
    <nav>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}">Home</a></li>
            <li class="breadcrumb-item">Event</li>
            <li class="breadcrumb-item active">Create VisionnaireL</li>
        </ol>
    </nav>
</div>
...
<section class="section">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">Create a New Visionnaire</h5>

                    @include('admin.partials.message')

                    <!-- Event Creation Form -->
                    <form action="{{ route('admin.visionnairedetails.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <label for="inputAdditionalEventImages" class="col-sm-2 col-form-label">Additional Images</label>
                            <div class="col-sm-10">
